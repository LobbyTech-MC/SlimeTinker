...
public final class SupportedPluginsManager {
    ...
    public static final String INFINITY_EXPANSION_NOTE = ThemeUtils.ADD_INFINITY + "无尽贪婪";
    public static final String SLIMEFUN_WARFARE_NOTE = ThemeUtils.ADD_SLIMEFUN_WARFARE + "战争工艺";
    public static final String DYNATECH_NOTE = ThemeUtils.ADD_DYNATECH + "动力科技";
    public static final String LITEXPANSION_NOTE = ThemeUtils.ADD_LITEXPANSION + "纳米科技";
    public static final String TRANSCENDENCE_NOTE = ThemeUtils.ADD_TRANSCENDENCE + "末地科技";
    public static final String NETWORKS_NOTE = ThemeUtils.ADD_NETWORKS + "网络";
